...
public class BackgroundMode extends CordovaPlugin {
    ...
    // Plugin namespace
    private static final String JS_NAMESPACE = "window.plugins.BackgroundMode";
    ...
    public void onDestroy() {
    	Log.w("BackgroundMode", "onDestroy");
        super.onDestroy();
        stopService();
    }
    ...
    private void enableMode() {
    	Log.w("BackgroundMode", "enableMode");
        isDisabled = false;
    ...
    private void disableMode() {
    	Log.w("BackgroundMode", "disableMode");
        stopService();
        isDisabled = true;
    }
